      ...
      <div className="container animate-enter">
        ...
        {isAdding && (
          ...
          >
            ...
            <div className="mb-md">
              <label className="text-sm text-muted mb-sm block">日期時間</label>
              <input
                type="datetime-local"
                value={transactionDate}
                onChange={(e) => setTransactionDate(e.target.value)}
                className="input-field"
                placeholder="選擇日期時間（留空則使用當前時間）"
              />
              <p className="text-xs text-muted mt-1">留空則使用當前時間</p>
            </div>
